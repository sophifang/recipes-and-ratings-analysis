...
The interesting result we found in the aggregates data is there were many recipes that consisted of sugar the most compared to the other nutritional values. This is apparent as sugar is much higher in every rating category and tells us most of the recipes collected contain sugar.
