...
The interesting result we found in the aggregates data is there were many recipes that consisted of sugar the most compared to the other nutritional values. This shows how much sugar a person would consume according to their percent daily value, which is around 60-80% per rating.
